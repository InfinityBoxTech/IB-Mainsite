...
export default function MetricsStrip({ metrics }: MetricsStripProps) {
	...
	return (
		<section className='relative bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 section-padding py-16 md:py-24 pb-24 md:pb-32 overflow-hidden'>
			{/* Grid Pattern */}
