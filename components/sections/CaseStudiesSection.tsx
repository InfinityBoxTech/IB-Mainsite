...
const caseStudies = [
	{
		...
		challenge: '25 locations with inconsistent hygiene standards',
	...
	},
	{
		...
		challenge: '2M sq ft facility seeking LEED certification',
		result: 'LEED certification support achieved',
		metrics: [
			{
